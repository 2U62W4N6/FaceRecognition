...
if __name__ == '__main__':
    ...
    # Aufgabe 1a)
    pcs, points_d2 = calculate_pca(one)
    recreate_one = project_points_into_orginal_space(points_d2)

    plot_image(one)
    plt.show()

    plot_image(recreate_one)
    plt.show()

    # Aufgabe 1b)
    pcs, points_d2 = calculate_pca(data)
    recreate_data = project_points_into_orginal_space(points_d2)
    
    plot_image(data[1])
    plt.show()

    plot_image(recreate_data[1])
    plt.show()


    # Aufgabe 2)
    plot_interactive(points_d2, data)
    plt.show()
